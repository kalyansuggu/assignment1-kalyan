...
public class Hexion {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.get("https://tools.in.capgemini.com/IKON2_EUC/login?accountName=HXN_dc_14_04");
		   ...
		   Select s=new Select(ele);
			...
			// Thread.sleep(5000);
			 WebElement ele1= driver.findElement(By.xpath("//th[@rowspan='1'][12]"));
				...
				String path=".\\datafiles\\HealthCheck_V2_011-06-2023.xlsx"; 
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		File dest3=new File("./photo/dashboardhexion.png");
