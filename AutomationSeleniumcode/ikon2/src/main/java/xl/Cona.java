...
public class Cona {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.get("https://tools.in.capgemini.com/IKON2_CPRS/login?accountName=CONA");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 26, 4, lastkocreated);
		...
		xlutil.setCellData("Sheet1", 26, 6, mttr);
