...
public class Ferro {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\SUGKALYA\\Downloads\\chromedriver_win32 (10)/chromedriver.exe");
		   ...
		   Select s=new Select(ele);
			...
			// Thread.sleep(5000);
			 WebElement ele1= driver.findElement(By.xpath("//th[@rowspan='1'][12]"));
				...
				String path=".\\datafiles\\HealthCheck_V2_04-07-2023.xlsx"; 
