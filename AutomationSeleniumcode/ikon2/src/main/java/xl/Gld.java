...
public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.get("https://tools.in.capgemini.com/IKON2_OTH/login?accountName=GLD");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 22, 4, lastkocreated);
		...
		xlutil.setCellData("Sheet1", 22, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboardgld.png");
