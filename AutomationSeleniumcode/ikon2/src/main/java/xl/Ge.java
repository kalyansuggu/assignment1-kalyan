...
public class Ge {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.get("http://in-blr-natools:5400/IKON2_MFG/login?accountName=GEL");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 6, 4, lastkocreated);
		
		driver.findElement(By.id("nav-helpdesk-tab")).click();
		driver.findElement(By.id("subject")).sendKeys("health check ge");
       ...
       String mttr = driver.findElement(By.xpath("//p[@class='f24']")).getText();
		...
		xlutil.setCellData("Sheet1", 6, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboardge.png");
