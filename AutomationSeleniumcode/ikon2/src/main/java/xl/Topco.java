...
public class Topco {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		//System.setProperty("webdriver.chrome.driver","C:\\Users\\SUGKALYA\\Downloads\\chromedriver_win32 (5)/chromedriver.exe");
		...
		driver.get("http://in-blr-natools:5200/IKON2_CPRS/login?accountName=TPC");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 10, 4, lastkocreated);
	...
	xlutil.setCellData("Sheet1", 10, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboardtopco.png");
