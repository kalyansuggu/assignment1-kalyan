...
public class BD {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.get("https://tools.in.capgemini.com/IKON2_ALS/login?accountName=BD");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		driver.findElement(By.id("subject")).sendKeys("health check bd ");
		...
		File dest3=new File("./photo/dashboardbd.png");
