...
public class Bimbo {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.get("https://tools.in.capgemini.com/IKON2_OTH/login?accountName=BIM");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 14, 4, lastkocreated);
		...
		xlutil.setCellData("Sheet1", 14, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboardbimbo.png");
