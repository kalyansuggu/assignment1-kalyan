...
public class all {
	public static void main(String[] args) throws InterruptedException, IOException{
		...
		driver.get("http://in-blr-natools:8120/IKON_CSL/login ");
...
/*Thread.sleep(3000);
	   ...
	   Select s=new Select(ele);
		...
		driver.findElement(By.id("subject")).sendKeys("health check 16-05-2022");
		driver.findElement(By.id("shortdescription")).sendKeys("health check 16-05-2022");
		driver.findElement(By.id("description")).sendKeys("health check 16-05-2022");
		driver.findElement(By.cssSelector("button[type='submit']")).click();*/
		...
		driver.findElement(By.xpath("(//a[@class='d-block selected'])[1]")).click();
		//driver.findElement(By.xpath("(//a[@class='d-block selected'])[2]")).click();
		driver.findElement(By.xpath("(//a[@class='d-block selected'])[4]")).click();
		driver.findElement(By.xpath("(//a[@class='report-name'])[5]")).click();
		driver.findElement(By.xpath("(//a[@class='d-block'])[22]")).click();
		driver.findElement(By.xpath("(//a[@class='d-block'])[26]")).click();
		
		//driver.findElement(By.cssSelector("input[class='d-block weekly']")).click();
