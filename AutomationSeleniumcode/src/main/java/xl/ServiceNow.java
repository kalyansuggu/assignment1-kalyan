package xl;
	...
	public class ServiceNow {
		...
		public static void main(String[] args) throws IOException, InterruptedException {
			...
			System.setProperty("webdriver.chrome.driver","C:\\Users\\SUGKALYA\\Downloads\\chromedriver_win32 (7)/chromedriver.exe");

			WebDriver driver= new ChromeDriver();
			driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
			driver.manage().window().maximize();
			driver.get("https://sncapappsoneprod.service-now.com/navpage.do");
			
			driver.findElement(By.xpath("//input[@id='user_name']")).sendKeys("prasrini");
			driver.findElement(By.xpath("//input[@id='user_password']")).sendKeys("Prasrini123");
		...
		/*	driver. findElement(By.id("nav-tickets-tab")).click();
			...
			String path=".\\datafiles\\HealthCheck_93.xlsx"; 
	...
	int rows=table.findElements(By.xpath("tr")).size();
		...
		String reportedDate = driver.findElement(By.xpath("//table[@class='table table-header table-hover border f13 table-responsive dataTable no-footer']/tbody/tr[1]/td[12]")).getText();
			...
			File dest3=new File("./photo/dashboardpanasonic.png");
