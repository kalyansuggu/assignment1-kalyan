package xl;
	...
	public class Ikon2automation {
		public static void main(String[] args) throws IOException, InterruptedException {
			...
			driver.get("http://in-blr-natools:8090/IKON2_ALS/login?accountName=JMFE");
			...
			//	driver.findElement(By.[@id="kolist-tables"]/tbody/tr[1]/td[1])).click();
				//driver.findElement(By.xpath("//table[@class='table table-header table-hover border f13 table-responsive dataTable no-footer']/tbody/tr[1]/td[1]")).click();
            ...
            b.*/
          //  moveToElement(
               //  WebElement click =driver.findElement(By.xpath("//table[@class='table table-header table-hover border f13 table-responsive dataTable no-footer']/tbody/tr[1]/td[1]"));
                // click.click();
                 //.perform();
           // Actions b=new Actions(driver);
//b.doubleClick(ele2).perform();
			
			/*String path=".\\datafiles\\HealthCheck_27_07_2022.xlsx"; 
...
//			int rows=table.findElements(By.xpath("tr")).size();
			...
			String koUsage = driver.findElement(By.xpath("//table[@class='table table-header table-hover border f13 table-responsive dataTable no-footer']/tbody/tr[1]/td[10]")).getText();
			 
			
			//xlutil.setCellData("Sheet1", 21, 2, reportedDate);
			//xlutil.setCellData("Sheet1", 1, 1, koUsage);
			
			//String lastupdatedate = driver.findElement(By.xpath("//p[@class='p-0 pb-1 mb-1 cg-dark-blue font-weight-bold']")).getText();
			//xlutil.setCellData("Sheet1", 21, 3, lastupdatedate);
		...
		//	Thread.sleep(5000);
			...
			//driver.findElement(By.xpath(//a[href="/IKON2_MFG/editKO/KS10284"])).click();
			driver.findElement(By.xpath("//a[@href=\"/IKON2_MFG/editKO/KS10284\"]")).click();
		...
		//	Actions a1=new Actions(driver);
	      ...
	      //  String lastkocreated = driver.findElement(By.xpath("//table[@class='table table-header table-hover border f13 table-responsive dataTable no-footer']/tbody/tr[1]/td[11]")).getText();*/
			...
			//xlutil.setCellData("Sheet1", 21, 4, lastkocreated);
			...
			/*xlutil.setCellData("Sheet1", 21, 6, mttr);
	        TakesScreenshot ts3= (TakesScreenshot) driver;
			
			File ram3=ts3.getScreenshotAs(OutputType.FILE);
			
			File dest3=new File("./photo/dashboardcona.png");
