...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 17, 4, lastkocreated);
		...
		xlutil.setCellData("Sheet1", 17, 6, mttr);
