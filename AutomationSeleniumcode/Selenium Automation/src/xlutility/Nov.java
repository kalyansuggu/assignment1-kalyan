...
public static void main(String[] args) throws IOException, InterruptedException {
	...
	driver.get("http://in-blr-natools:5300/IKON2_EUC/login?accountName=NOV");
		...
		//driver.findElement(By.cssSelector("input[name='accountName']")).sendKeys("DEMO");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 24, 4, lastkocreated);
		
		driver.findElement(By.id("nav-helpdesk-tab")).click();
		driver.findElement(By.id("subject")).sendKeys("health check nov");
		...
		xlutil.setCellData("Sheet1", 24, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboardnov.png");
