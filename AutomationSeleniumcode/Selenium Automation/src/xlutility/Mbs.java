...
public static void main(String[] args) throws IOException, InterruptedException {
	...
	driver.manage().window().maximize();
		driver.get("https://tools.in.capgemini.com/IKON2_ALS/login?accountName=MBS");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 23, 4, lastkocreated);
		...
		xlutil.setCellData("Sheet1", 23, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboardmbs.png");
