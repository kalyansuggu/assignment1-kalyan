...
public class Omni {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		 System.setProperty("webdriver.chrome.driver","C:\\Users\\SUGKALYA\\Downloads\\chromedriver-win32\\chromedriver-win32/chromedriver.exe");
			...
			driver.get("https://tools.in.capgemini.com/IKON2_ALS/login?accountName=OMN");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 4, 4, lastkocreated);
       ...
       String mttr = driver.findElement(By.xpath("//p[@class='f24']")).getText();
		...
		xlutil.setCellData("Sheet1", 4, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboardomni.png");
