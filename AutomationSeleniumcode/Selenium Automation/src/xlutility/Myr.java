...
public static void main(String[] args) throws IOException, InterruptedException {
	...
	driver.get("https://tools.in.capgemini.com/IKON2_CPRS/login?accountName=MYR");
		...
		xlutil.setCellData("Sheet1", 25, 4, lastkocreated);
		...
		xlutil.setCellData("Sheet1", 25, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboardmyr.png");
