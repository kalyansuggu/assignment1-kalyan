...
public static void main(String[] args) throws IOException, InterruptedException {
	...
	driver.manage().window().maximize();
		driver.get("http://inblramstooldev:8080/IKON2Demo/login");
...
//		int rows=table.findElements(By.xpath("tr")).size();
		...
		xlutil.setCellData("Sheet1", 29, 4, lastkocreated);
		...
		xlutil.setCellData("Sheet1", 29, 6, mttr);
        TakesScreenshot ts3= (TakesScreenshot) driver;
		
		File ram3=ts3.getScreenshotAs(OutputType.FILE);
		
		File dest3=new File("./photo/dashboarddemo.png");
