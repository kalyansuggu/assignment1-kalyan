...
public class ge {
	public static void main(String[] args) throws InterruptedException, IOException{
		...
		driver.get("http://in-blr-natools:8120/IKON_GELighting/login ");
...
Thread.sleep(3000);
	   ...
	   Select s=new Select(ele);
		...
		driver.findElement(By.id("subject")).sendKeys("health check 18-05-2022");
		driver.findElement(By.id("shortdescription")).sendKeys("health check 18-05-2022");
		driver.findElement(By.id("description")).sendKeys("health check 18-05-2022");
		driver.findElement(By.cssSelector("button[type='submit']")).click();
