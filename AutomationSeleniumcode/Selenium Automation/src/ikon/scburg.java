...
Thread.sleep(3000);
	...
	/*	driver.findElement(By.id("nav-kolist-tab")).click();
		...
		driver.findElement(By.id("subject")).sendKeys("health check 17-05-2022");
		driver.findElement(By.id("shortdescription")).sendKeys("health check 17-05-2022");
		driver.findElement(By.id("description")).sendKeys("health check 17-05-2022");
		driver.findElement(By.cssSelector("button[type='submit']")).click();
